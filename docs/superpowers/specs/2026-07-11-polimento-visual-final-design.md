...
Depende de: app do aluno (`2026-07-05-javablocks-aluno-design.md`) e painel do professor (`2026-07-10-painel-professor-integrado-design.md`), ambos já implementados.
